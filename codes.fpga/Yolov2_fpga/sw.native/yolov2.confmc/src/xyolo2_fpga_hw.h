...
#ifndef _XYOLO2_FPGA_HW_H
#define _XYOLO2_FPGA_HW_H
...
#ifdef USE_CON_FMC
#define CSR_WRITE(BaseAddress, RegOffset, Data)  BfmWrite(handle, (unsigned int)((BaseAddress) + (RegOffset)), (unsigned int*)&(Data), 4, 1)
#define CSR_READ(BaseAddress, RegOffset, Data) BfmRead (handle, (unsigned int)((BaseAddress) + (RegOffset)), (unsigned int*)&(Data), 4, 1)
